...
# Implementation of the Twin Delayed Deep Deterministic Policy Gradient (TD3) algorithm
# Paper: https://arxiv.org/abs/1802.09477
# Note: This implementation largely relies on the authors' PyTorch implementation
...
class TD3(object):
    ...
    def update_parameters(self, replay_buffer, batch_size=256):
        ...
        state, action, next_state, reward, mask, _, _ = replay_buffer.sample(batch_size)
